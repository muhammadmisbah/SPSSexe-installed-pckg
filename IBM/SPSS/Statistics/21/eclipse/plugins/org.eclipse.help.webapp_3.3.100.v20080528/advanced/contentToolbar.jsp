...
<% 
	...
	boolean isHighLightOn = UrlUtil.isHighlight(request, response);
	String highLightButtonTip = isHighLightOn?"highlightoff":"highlighton";
%>
...
<jsp:include page="toolbar.jsp">
	...
	<jsp:param name="tooltip"  value='<%=highLightButtonTip%>'/>
