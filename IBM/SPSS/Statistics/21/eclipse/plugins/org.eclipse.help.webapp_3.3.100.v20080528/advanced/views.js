...
{ 	
	...
	// show appropriate frame
 	...
 	{
 		var iframesDiv = parent.ViewsFrame.document.getElementById(iframes[i].id+"Div");			
  		if (iframes[i].id != view){
   			iframes[i].className = "hidden";
   			iframes[i].style.visibility="hidden";
   			
   			iframesDiv.className="div_hidden";
   			iframesDiv.style.display="none";
  		}else{
   			iframes[i].className = "visible";
   			iframes[i].style.visibility="visible";
   			
   			iframesDiv.className = "div_visible";
   			iframesDiv.style.display="";
   			iframesDiv.style.width="100%";
   			iframesDiv.style.height="100%";
   			try {
