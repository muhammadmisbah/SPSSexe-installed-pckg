...
function selectWorkingSet() {
	...
	var maxHits = window.opener.document.forms["searchForm"].maxHits.value;
	if (searchWord) {
		search += "searchWord="+encodeURIComponent(searchWord)+"&maxHits="+maxHits+"&workingSet=" + encodeURIComponent(workingSet);;
	}
	else
...
function sizeList() {
    resizeVertical("workingSetContainer", "filterTable", "buttonArea", 100, 35);
}
